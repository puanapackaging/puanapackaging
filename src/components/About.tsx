...
// import { CheckCircle, Building2, Award, Users, Leaf } from 'lucide-react';
...
//   return (
//     <section id="about-us" className="py-20 bg-secondary/10">
//       <div className="container mx-auto px-4">
//         <div className="max-w-3xl mx-auto text-center mb-16">
//           <span className="text-accent font-semibold mb-2 block">WHO WE ARE</span>
...
//               <h3 className="text-2xl font-bold mb-4 text-primary">State-of-the-Art Facility</h3>
...
//           <div>
//             <h3 className="text-2xl font-bold mb-8 text-primary">Our Core Values</h3>
